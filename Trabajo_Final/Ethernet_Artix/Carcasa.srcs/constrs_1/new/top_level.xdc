...
set_property PACKAGE_PIN C22 [get_ports LED];                set_property IOSTANDARD LVCMOS25 [get_ports LED];  # TE0712 = B16_L20_P - KIT ARTIX = JB1-50
...
set_property PACKAGE_PIN B22 [get_ports nLED];               set_property IOSTANDARD LVCMOS25 [get_ports nLED];  # TE0712 = B16_L20_N - KIT ARTIX = JB1-52
...
#set_property PACKAGE_PIN A15 [get_ports {LVDS_SP3_P[46]}];   set_property IOSTANDARD BLVDS_25 [get_ports {LVDS_SP3_P[46]}];  # TE0712 = B16_L9_P - KIT ARTIX = JB1-57
#set_property PACKAGE_PIN A21 [get_ports {LVDS_SP3_N[40]}];   set_property IOSTANDARD BLVDS_25 [get_ports {LVDS_SP3_N[40]}];  # TE0712 = B16_L21_N - KIT ARTIX = JB1-58
...
#set_property PACKAGE_PIN C19 [get_ports CLK_SP3_N];   set_property IOSTANDARD BLVDS_25 [get_ports CLK_SP3_N];  # TE0712 = B16_L13_N - KIT ARTIX = JB1-62
...
#set_property PACKAGE_PIN D19 [get_ports {LVDS_SP3_N[30]}];   set_property IOSTANDARD BLVDS_25 [get_ports {LVDS_SP3_N[30]}];  # TE0712 = B16_L14_N - KIT ARTIX = JB1-68
...
#set_property PACKAGE_PIN C14 [get_ports {LVDS_SP3_P[38]}];   set_property IOSTANDARD BLVDS_25 [get_ports {LVDS_SP3_P[38]}];  # TE0712 = B16_L3_P - KIT ARTIX = JB1-72
...
#set_property PACKAGE_PIN C17 [get_ports {LVDS_SP3_N[31]}];   set_property IOSTANDARD BLVDS_25 [get_ports {LVDS_SP3_N[31]}];  # TE0712 = B16_L12_N - KIT ARTIX = JB1-78
...
#set_property PACKAGE_PIN C13 [get_ports {LVDS_SP3_P[37]}];   set_property IOSTANDARD BLVDS_25 [get_ports {LVDS_SP3_P[37]}];  # TE0712 = B16_L8_P - KIT ARTIX = JB1-84
...
#set_property PACKAGE_PIN U20 [get_ports {LVDS_SP3_P[11]}];   set_property IOSTANDARD BLVDS_25 [get_ports {LVDS_SP3_P[11]}];  # TE0712 = B14_L11_P - KIT ARTIX = JB2-25
...
#set_property PACKAGE_PIN V20 [get_ports {LVDS_SP3_N[11]}];   set_property IOSTANDARD BLVDS_25 [get_ports {LVDS_SP3_N[11]}];  # TE0712 = B14_L11_N - KIT ARTIX = JB2-27
...
#set_property PACKAGE_PIN L19 [get_ports {LVDS_SP3_P[43]}];   set_property IOSTANDARD BLVDS_25 [get_ports {LVDS_SP3_P[43]}];  # TE0712 = B15_L14_P - KIT ARTIX = JB2-51
...
#set_property PACKAGE_PIN L20 [get_ports {LVDS_SP3_N[43]}];   set_property IOSTANDARD BLVDS_25 [get_ports {LVDS_SP3_N[43]}];  # TE0712 = B15_L14_N - KIT ARTIX = JB2-53
...
#set_property PACKAGE_PIN W15  [get_ports RST_CAB_AUX_P];	set_property IOSTANDARD LVCMOS25 [get_ports RST_CAB_AUX_P]; 	# TE0712 = B13_L16_P	KIT ARTIX = JB3-37
#set_property PACKAGE_PIN V10  [get_ports {COL[2]}];			set_property IOSTANDARD LVCMOS25 [get_ports {COL[2]}]; 			# TE0712 = B13_L10_P	KIT ARTIX = JB3-38
#set_property PACKAGE_PIN W16  [get_ports RST_CAB_AUX_N];	set_property IOSTANDARD LVCMOS25 [get_ports RST_CAB_AUX_N]; 	# TE0712 = B13_L16_N	KIT ARTIX = JB3-39
#set_property PACKAGE_PIN W10  [get_ports {COL[1]}];			set_property IOSTANDARD LVCMOS25 [get_ports {COL[1]}]; 			# TE0712 = B13_L10_N	KIT ARTIX = JB3-40
#set_property PACKAGE_PIN Y16  [get_ports LVDS_CAB_AUX_P];	set_property IOSTANDARD LVCMOS25 [get_ports LVDS_CAB_AUX_P];	# TE0712 = B13_L1_P		KIT ARTIX = JB3-41
#set_property PACKAGE_PIN T14  [get_ports {SEMI[11]}];			set_property IOSTANDARD LVCMOS25 [get_ports {SEMI[11]}]; 			# TE0712 = B13_L15_P	KIT ARTIX = JB3-42
#set_property PACKAGE_PIN AA16 [get_ports LVDS_CAB_AUX_N];	set_property IOSTANDARD LVCMOS25 [get_ports LVDS_CAB_AUX_N];	# TE0712 = B13_L1_N		KIT ARTIX = JB3-43
#set_property PACKAGE_PIN T15  [get_ports {SEMI[9]}];			set_property IOSTANDARD LVCMOS25 [get_ports {SEMI[9]}]; 			# TE0712 = B13_L15_N	KIT ARTIX = JB3-44
#set_property PACKAGE_PIN AA15 [get_ports RST_CAB_P];		set_property IOSTANDARD LVCMOS25 [get_ports RST_CAB_P]; 		# TE0712 = B13_L4_P		KIT ARTIX = JB3-47
...
#set_property PACKAGE_PIN AB15 [get_ports RST_CAB_N];		set_property IOSTANDARD LVCMOS25 [get_ports RST_CAB_N]; 		# TE0712 = B13_L4_N		KIT ARTIX = JB3-49
...
#set_property PACKAGE_PIN AB17 [get_ports UART_CAB_AUX_TX];	set_property IOSTANDARD LVCMOS25 [get_ports UART_CAB_AUX_TX];	# TE0712 = B13_L2_N		KIT ARTIX = JB3-51
...
#set_property PACKAGE_PIN AB16 [get_ports UART_CAB_AUX_RX];	set_property IOSTANDARD LVCMOS25 [get_ports UART_CAB_AUX_RX];	# TE0712 = B13_L2_P		KIT ARTIX = JB3-53
...
#set_property PACKAGE_PIN W11  [get_ports LVDS_CAB_P];		set_property IOSTANDARD LVCMOS25 [get_ports LVDS_CAB_P];	 	# TE0712 = B13_L12_P	KIT ARTIX = JB3-57
#set_property PACKAGE_PIN V13  [get_ports UART_CAB_RX];		set_property IOSTANDARD LVCMOS25 [get_ports UART_CAB_RX]; 		# TE0712 = B13_L13_P	KIT ARTIX = JB3-58
#set_property PACKAGE_PIN W12  [get_ports LVDS_CAB_N];		set_property IOSTANDARD LVCMOS25 [get_ports LVDS_CAB_N]; 		# TE0712 = B13_L12_P	KIT ARTIX = JB3-59
#set_property PACKAGE_PIN V14  [get_ports UART_CAB_TX];		set_property IOSTANDARD LVCMOS25 [get_ports UART_CAB_TX]; 		# TE0712 = B13_L13_N	KIT ARTIX = JB3-60