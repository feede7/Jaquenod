...
elaborate()
{
  $xv_path/bin/xelab --relax --debug typical --mt auto -L xil_defaultlib -L secureip -L xpm --snapshot Inv_KPlus xil_defaultlib.Inv_KPlus -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  $xv_path/bin/xsim Inv_KPlus -key {Behavioral:sim_1:Functional:Inv_KPlus} -tclbatch cmd.tcl -log simulate.log
}
