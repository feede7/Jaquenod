...
HD_PWD='/home/farbizu/GIT/Jaquenod/Trabajo_Final/Documentacion/Ethernet-communication-VHDL/Ethernet-comunication-VHDL/Ethernet-comunication-VHDL.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log En_Head.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source En_Head.tcl -notrace
