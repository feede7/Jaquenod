...
elaborate()
{
  $xv_path/bin/xelab --relax --debug typical --mt auto -L xil_defaultlib -L secureip -L xpm --snapshot Kplus xil_defaultlib.Kplus -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  $xv_path/bin/xsim Kplus -key {Behavioral:sim_1:Functional:Kplus} -tclbatch cmd.tcl -log simulate.log
}
