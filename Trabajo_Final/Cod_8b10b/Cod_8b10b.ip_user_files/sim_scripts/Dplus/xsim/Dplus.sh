...
elaborate()
{
  $xv_path/bin/xelab --relax --debug typical --mt auto -L xil_defaultlib -L secureip -L xpm --snapshot Dplus xil_defaultlib.Dplus -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  $xv_path/bin/xsim Dplus -key {Behavioral:sim_1:Functional:Dplus} -tclbatch cmd.tcl -log simulate.log
}
