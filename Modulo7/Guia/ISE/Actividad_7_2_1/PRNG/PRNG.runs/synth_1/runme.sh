...
HD_PWD='/media/storage/Documents/GIT/Jaquenod/Modulo7/Guia/ISE/Actividad_7_2_1/PRNG/PRNG.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log En_PRNG_150.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source En_PRNG_150.tcl
