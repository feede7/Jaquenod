...
HD_PWD='/home/fede/GIT/Jaquenod/Modulo11/Guia/ISE/Actividad_11_2_1/Cod_8b10b/Cod_8b10b.runs/Dplus_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Dplus.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Dplus.tcl
