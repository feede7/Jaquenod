...
elaborate()
{
  $xv_path/bin/xelab --relax --debug typical --mt auto -L xil_defaultlib -L secureip -L xpm --snapshot DCh xil_defaultlib.DCh -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  $xv_path/bin/xsim DCh -key {Behavioral:sim_1:Functional:DCh} -tclbatch cmd.tcl -log simulate.log
}
