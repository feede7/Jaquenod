...
elaborate()
{
  $xv_path/bin/xelab --relax --debug typical --mt auto -L xil_defaultlib -L secureip -L xpm --snapshot KCh xil_defaultlib.KCh -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  $xv_path/bin/xsim KCh -key {Behavioral:sim_1:Functional:KCh} -tclbatch cmd.tcl -log simulate.log
}
