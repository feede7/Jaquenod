...
elaborate()
{
  $xv_path/bin/xelab --relax --debug typical --mt auto -L xil_defaultlib -L secureip -L xpm --snapshot Inv_Ch xil_defaultlib.Inv_Ch -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  $xv_path/bin/xsim Inv_Ch -key {Behavioral:sim_1:Functional:Inv_Ch} -tclbatch cmd.tcl -log simulate.log
}
