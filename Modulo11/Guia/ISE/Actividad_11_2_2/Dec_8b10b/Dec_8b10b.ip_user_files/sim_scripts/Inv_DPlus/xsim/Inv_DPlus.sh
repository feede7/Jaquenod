...
elaborate()
{
  $xv_path/bin/xelab --relax --debug typical --mt auto -L xil_defaultlib -L secureip -L xpm --snapshot Inv_DPlus xil_defaultlib.Inv_DPlus -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  $xv_path/bin/xsim Inv_DPlus -key {Behavioral:sim_1:Functional:Inv_DPlus} -tclbatch cmd.tcl -log simulate.log
}
